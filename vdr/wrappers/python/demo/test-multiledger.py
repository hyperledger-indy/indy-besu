...
async def demo():
    ...
    router = LedgerRouter(ledgers_configurations)
    ...
    print("2. Publish DID:" +network2)
    did = 'did:ethr:' + network2 + ':' + identity['address']
    ...
    client = router.get_ledger_for_identifier(schema.id)
    print("Router Return:" +client.network())
    ...
    client = router.get_ledger_for_identifier(cred_def.id)
    print("Router Return:" +client.network())    
    ...
    client = router.get_ledger_for_identifier(revocation_registry.id)
    print("Router Return:" +client.network())    
