...
WRAPPER_PATH="wrappers/swift/Sources/Indy_besu_vdr"
...
cargo run --bin uniffi-bindgen generate src/indy_besu_vdr.udl --language swift -o $OUT_PATH --lib-file ./target/$CURRENT_ARCH/release/$LIBRARY_NAME
...
#endif
EOT
cat $OUT_PATH/import.txt $OUT_PATH/indy_besu_vdr.swift > $WRAPPER_PATH/indy_besu_vdr.swift
